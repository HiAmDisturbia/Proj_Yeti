...
def create_app():
    ...
    def homepage():
        ...
        if request.method == 'POST':
            if request.form['sauver'] =='date_stockée' :                
                ...
                #Réalisation du diagramme camembert permettant de voir les erruers les plus courantes
                #avec une sauvegarde à la fin
